...
(function (e) {
    var t = function (t, n) {
        ...
        if (r.directionNav) {
            s.append('<div class="nivo-directionNav"><a class="nivo-prevNav glyphicon glyphicon-menu-left"></a><a class="nivo-nextNav glyphicon glyphicon-menu-right"></a></div>');
        ...
        if (r.controlNav) {
            ...
            for (var l = 0; l < o.length; l++) {
                if (r.controlNavThumbs) {
                    ...
                    if (c.attr("data-thumb")) i.controlNavEl.append('')
                } else {
